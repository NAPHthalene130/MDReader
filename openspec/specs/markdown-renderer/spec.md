...
Render parsed Markdown tokens into platform-native views on Windows and Android, including rendered LaTeX formulas via KaTeX, Mermaid diagrams as SVG, syntax-highlighted code blocks, and images. Output must be visually consistent across both platforms.

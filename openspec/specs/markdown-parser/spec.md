...
Parse Markdown files including standard CommonMark/GFM syntax, LaTeX formulas (inline `$...$` and block `$$...$$`), Mermaid diagrams in fenced code blocks (` ```mermaid`), and syntax-highlighted code blocks for common programming languages.

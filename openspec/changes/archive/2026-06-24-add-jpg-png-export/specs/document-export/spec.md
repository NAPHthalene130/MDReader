...
**Reason**: JPG and PNG export are now fully implemented and functional.
**Migration**: Selecting JPG or PNG from the export menu now triggers the corresponding export instead of being disabled.
